...
#define XQC_H3_CONN_ERR(h3_conn, err, ret)                                              \
    do {                                                                                \
...
void xqc_h3_conn_remove_blocked_stream(xqc_h3_conn_t *h3c,
...
ssize_t xqc_h3_conn_send_ins(xqc_qpack_ins_type_t type, xqc_var_buf_t *buf,
                             void *user_data);
