...
main(int argc, char *argv[])
{
    ...
    if (!CU_add_test(pSuite, "xqc_cid_test", xqc_test_cid)
        ...
        || !CU_add_test(pSuite, "xqc_test_stream_frame", xqc_test_stream_frame)
                ...
                || !CU_add_test(pSuite, "xqc_test_stream_frame_dense_buffer_budget", xqc_test_stream_frame_dense_buffer_budget)
                || !CU_add_test(pSuite, "xqc_test_stream_frame_dense_prefix_liveness", xqc_test_stream_frame_dense_prefix_liveness)
                || !CU_add_test(pSuite, "xqc_test_stream_frame_prefix_respects_hard_cap", xqc_test_stream_frame_prefix_respects_hard_cap)
                || !CU_add_test(pSuite, "xqc_test_stream_frame_window_binds_at_300b", xqc_test_stream_frame_window_binds_at_300b)
                || !CU_add_test(pSuite, "xqc_test_stop_sending_drops_queued_stream_packets", xqc_test_stop_sending_drops_queued_stream_packets)
                || !CU_add_test(pSuite, "xqc_test_stop_sending_spares_other_streams", xqc_test_stop_sending_spares_other_streams)
        ...
        || !CU_add_test(pSuite, "xqc_test_h3_blocked_buf_limit_closes_the_connection",
                        xqc_test_h3_blocked_buf_limit_closes_the_connection)
        || !CU_add_test(pSuite, "xqc_test_h3_blocked_buf_default_is_asymmetric",
